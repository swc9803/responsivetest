<template>
  <nav>
    ...
    <ul class="menu">
      <li>
        <router-link class="move" :to="{ name: 'Home'}">Home</router-link>
      </li>
      <li>
        <router-link class="move" :to="{ name: 'Myworks'}">Myworks</router-link>
      </li>
      <li>
        <router-link class="move" :to="{ name: 'About'}">About</router-link>
      </li>
    </ul>
